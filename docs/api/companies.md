...
Manage companies within your OhMyCompany instance.
...
Company logo uploads use the normal OhMyCompany attachment size limit.
...
| `logoUrl` | string | Optional OhMyCompany asset content path for the stored logo image |
