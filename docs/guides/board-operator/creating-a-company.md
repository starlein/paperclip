...
A company is the top-level unit in OhMyCompany. Everything — agents, tasks, goals, budgets — lives under a company.
...
Set monthly budgets at both the company and per-agent level. OhMyCompany enforces:
