...
- **`id`**: Unique identifier, used as the npm package name suffix (`@paperclipai_dld/mod-observability`)
...
```typescript
import type { ModuleAPI } from "@paperclipai_dld/core";
...
export const modulePages = [
  {
    path: "/observability",
    label: "Observability",
    component: lazy(() => import("@paperclipai_dld/mod-observability/ui")),
  },
];
...
export const dashboardWidgets = [
  {
    ...
    label: "Token Burn Rate",
    placement: "dashboard",
    component: lazy(() => import("@paperclipai_dld/mod-observability/ui").then(m => ({ default: m.TokenBurnRateWidget }))),
  },
];
```
...
10. **`@paperclipai_dld/module-sdk`** — TypeScript types for `ModuleAPI`, `HookEvent`, `HookHandler`, manifest schema
