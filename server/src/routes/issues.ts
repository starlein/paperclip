    ...
    const createBody = {
      ...
      ...(watchdogProductBugFollowUp
        ? {
          ...
          projectId: watchdogProductBugFollowUp.sourceIssue.projectId,
          goalId: watchdogProductBugFollowUp.sourceIssue.goalId,
          billingCode: watchdogProductBugFollowUp.sourceIssue.billingCode,
