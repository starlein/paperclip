/**
 * `@paperclipai_dld/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@paperclipai_dld/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@paperclipai_dld/plugin-sdk/ui";
 *
