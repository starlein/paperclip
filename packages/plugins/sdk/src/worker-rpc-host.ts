...
import type { PaperclipPluginManifestV1 } from "@paperclipai_dld/shared";
 ...
 * import { startWorkerRpcHost } from "@paperclipai_dld/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@paperclipai_dld/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
