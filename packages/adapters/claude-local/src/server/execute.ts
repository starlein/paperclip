...
import type { AdapterExecutionContext, AdapterExecutionResult } from "@paperclipai_dld/adapter-utils";
import type { RunProcessResult } from "@paperclipai_dld/adapter-utils/server-utils";
import {
  asString,
  asNumber,
  asBoolean,
