...
export function CliAuthPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-[2px] border border-border bg-card p-6 hud-panel hud-shimmer">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The OhMyCompany CLI can now finish authentication on the requesting machine.
          </p>
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-[2px] border border-border bg-card p-6 hud-panel hud-shimmer">
        <h1 className="text-xl font-semibold">Approve OhMyCompany CLI access</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          A local OhMyCompany CLI process is requesting board access to this instance.
        </p>
