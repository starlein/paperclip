 ...
 *
 * Plugin bundles are built with `external: ["@paperclipai_dld/plugin-sdk/ui", "react", "react-dom"]`,
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    ...
    "'@paperclipai_dld/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@paperclipai_dld/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@paperclipai_dld/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@paperclipai_dld/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
