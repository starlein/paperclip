...
export const help: Record<string, string> = {
  ...
  sandboxBootstrapCommand: "Optional shell command run inside the sandbox before the agent CLI starts. Use it to install tools, write wrapper scripts, or prepare runtime state.",
