...
export function DevRestartBanner({ devServer }: { devServer?: DevServerHealthStatus }) {
  ...
  return (
    <div className="border-b border-[var(--status-warning)]/30 bg-[var(--status-warning)]/5 text-[var(--status-warning)]">
      <div className="flex flex-col gap-3 px-3 py-2.5 md:flex-row md:items-center md:justify-between">
        <div className="min-w-0">
          <div className="flex items-center gap-2 text-[12px] font-semibold uppercase tracking-[0.18em]">
            ...
            {devServer.autoRestartEnabled ? (
              <span className="rounded-[2px] bg-[var(--status-warning)]/10 px-2 py-0.5 text-[10px] font-[var(--font-mono)] tracking-[0.14em]">
                Auto-Restart On
              </span>
            ) : null}
          </div>
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-[var(--status-warning)]/75">
            {sample.length > 0 ? (
              <span>
                Changed: {sample.join(", ")}
        ...
        <div className="flex shrink-0 items-center gap-2 text-xs font-medium">
          {devServer.waitingForIdle ? (
            <div className="inline-flex items-center gap-2 rounded-[2px] bg-[var(--status-warning)]/10 px-3 py-1.5">
